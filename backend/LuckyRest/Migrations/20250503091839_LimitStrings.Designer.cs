...
namespace LuckyRest.Migrations
{
    ...
    [Migration("20250503091839_LimitStrings")]
            ...
            modelBuilder.Entity("WorkshopMapWorkshopPlaylist", b =>
                {
                    ...
                    b.Property<string>("PlaylistsCollectionName")
                        .HasColumnType("character varying(50)");

                    b.HasKey("MapsWorkshopMapId", "PlaylistsCollectionName");

                    b.HasIndex("PlaylistsCollectionName");
            ...
            modelBuilder.Entity("WorkshopMapWorkshopPlaylist", b =>
                {
                    ...
                    b.HasOne("LuckyRest.Database.Entities.WorkshopPlaylist", null)
                        .WithMany()
                        .HasForeignKey("PlaylistsCollectionName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
